...
options.sigma=1;    % controls the sparsity of the feature transformation matrices
options.gamma=1;    % measures the contribution of the feature transformation
options.lambda=10;  % controls the learned graph 
